	...
	<div class="main">
		...
		<div class="info" style="padding-top: 2%; padding-left: 8%">
            ...
            <form action="reg.php" method="POST">
                ...
                <input class="btn" style="background-color: #46B4C5; margin-left: 32%; margin-top: 5%;" type="submit" name="reg" value="Зарегистрироваться">
            </form>
            <?php } ?>
            <div class="mt-2">
            ...
            <?php 
                    if($_POST['auto'] == 'Войти')
                    {
                        ...
                        if($num == 1){
                            echo "<br><br><div><p>Вы автоизовались, пройдите в <a href = 'profile.php'>Личный кабинет</a></p>";
                            echo "<input";
                        ...
                        {
                            echo "<br><br>Данные не верны, попробуйте еще раз <a href = 'reg.php'>Авторизоваться</a>";
                        }
